...
write.csv2(DataAnalisisClustersDiarios,file=paste(Nombre_Analisis,"/6 asignaciones diarias/Asignaciones ",NUM_CLUSTERS," clusters monthly.csv",sep=""),row.names=FALSE)
...
for (i in 1:length(Fechas)){
  ...
  write.csv2(DataAnalisisFecha,file=paste(Nombre_Analisis,"/8 evolucion mensual/Asignaciones ",NUM_CLUSTERS," clusters ",Fecha," monthly.csv",sep=""),row.names=FALSE)
}

Resultados$Fecha=Fechas

write.csv2(Resultados,file=paste(Nombre_Analisis,"/8 evolucion mensual/Asignaciones ",NUM_CLUSTERS," clusters Total monthly.csv",sep=""),row.names=FALSE)
...
png(paste(Nombre_Analisis,"/8 evolucion mensual/Asignaciones ",NUM_CLUSTERS," monthly.png",sep=""),width = 500, height = 250)
...
Nodes_Fecha_1=read.csv2(paste(Nombre_Analisis,"/8 evolucion mensual/Asignaciones ",NUM_CLUSTERS," clusters ",fecha_1," monthly.csv",sep=""))
Nodes_Fecha_2=read.csv2(paste(Nombre_Analisis,"/8 evolucion mensual/Asignaciones ",NUM_CLUSTERS," clusters ",fecha_2," monthly.csv",sep=""))
...
write.csv2(TABLA,paste0(Nombre_Analisis,"/9 matriz de transicion/matriz de transicion ",fecha_1," ",fecha_2," monthly.csv"),row.names = TRUE)
write.csv2(TABLA2,paste0(Nombre_Analisis,"/9 matriz de transicion/matriz de transicion relativa ",fecha_1," ",fecha_2," monthly.csv"),row.names = TRUE)
write.csv2(TABLA3,paste0(Nombre_Analisis,"/9 matriz de transicion/matriz de transicion relativa salida ",fecha_1," ",fecha_2," monthly.csv"),row.names = TRUE)
write.csv2(TABLA4,paste0(Nombre_Analisis,"/9 matriz de transicion/matriz de transicion relativa llegada ",fecha_1," ",fecha_2," monthly.csv"),row.names = TRUE)

...
CarpetaInput = "Modelos Supervisados Cruzados"
CarpetaOutput = "Resultados Agregados Redes Neuronales 2 Franjas DEF"
...
ggplot(dataPlot, aes(x = reorder(Model, -Frequency), y = Frequency,fill = Model)) +
  geom_bar(stat = "identity") +
  geom_text(aes(label = Frequency), vjust = -0.5) +  # Añadir etiquetas encima de las barras

...
CarpetaOutput = "Modelos Supervisados 1 Franja Temporal"
Results = "Resultados Modelado Supervisado 1 Franja Temporal"
...
for (i in c(1:14,16:19,21:23,25:length(creados))){ #linea para ejecutar los dataset salvo los que tenian problemas
#for (i in c(21,25,26,27)){ #linea para ejecucioens particulares
  start.time = Sys.time()

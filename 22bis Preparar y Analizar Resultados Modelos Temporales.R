...
CarpetaInput = "Modelos Supervisados 1 Franja Temporal"
CarpetaOutput = "Resultados Agregados Redes Neuronales 1 Franja Temporal"
...
Colores=c("darkblue","blue","lightblue","darkblue","blue","lightblue","darkblue","blue","lightblue")
names(Colores)=levels(Estadisticas$Modelo)

layers=c(3,2,1,3,2,1,3,2,1)
